...
define("tools/alltools", ["require", "exports", "tools/copy", "tools/func", "tools/line", "tools/multi", "tools/pan", "tools/paste", "tools/poly", "tools/shape", "tools/surface", "tools/text", "tools/transform", "tools/undo", "tools/wall", "tools/zoom"], function (require, exports, copy_js_1, func_js_1, line_js_1, multi_js_1, pan_js_1, paste_js_1, poly_js_1, shape_js_1, surface_js_1, text_js_1, transform_js_1, undo_js_1, wall_js_1, zoom_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ZoomTool = exports.WallTool = exports.UndoTool = exports.TransformTool = exports.TextTool = exports.SurfaceTool = exports.ShapeTool = exports.PolyTool = exports.PasteTool = exports.PanTool = exports.MultiTool = exports.LineTool = exports.FuncTool = exports.CopyTool = void 0;
...
define("input", ["require", "exports", "color", "draw", "data", "courier"], function (require, exports, Color, Draw, Data, Courier) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("toolbox", ["require", "exports", "tools/alltools", "data", "courier", "input"], function (require, exports, Tools, Data, Courier, Input) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MenuItem = exports.ToolMenu = exports.Toolboxbox = exports.Toolbox = exports.ToolboxEntry = void 0;
            ...
            for (const toolbox of this.toolboxes) {
                ...
                for (const entry of toolbox.tools) {
                    switch (typeof entry.tbind) {
                        case 'number':
                            this.mouseTools.set(entry.tbind, entry.tool);
                            break;
                        case 'string':
                            this.keyTools.set(entry.tbind, entry.tool);
                            break;
                        case 'boolean':
                            this.wheelTools.set(entry.tbind, entry.tool);
                            break;
                    }
                }
            }
...
define("menu", ["require", "exports", "stamp", "data", "draw", "file", "courier"], function (require, exports, Stamp, Data, Draw, File, Courier) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MenuManager {
        ...
        addtool(box, entry) {
            ...
            menuevents.set('addtool-bindmouse', (manager, menu, e, target) => {
                ...
                const conflict = e.button != (entry === null || entry === void 0 ? void 0 : entry.tbind) && box.hasBind(e.button);
            ...
            menuevents.set('addtool-bindkey', (manager, menu, e, target) => {
                ...
                const conflict = e.key != (entry === null || entry === void 0 ? void 0 : entry.tbind) && box.hasBind(e.key);
                target.classList.toggle('conflict', conflict);
                resolve = conflict ? undefined : e.key;
            });
            menuevents.set('addtool-bindwheel', (manager, menu, e, target) => {
                target.value = 'scr ' + (e.deltaY < 0 ? 'up' : 'dn');
                const conflict = (e.deltaY < 0) != (entry === null || entry === void 0 ? void 0 : entry.tbind) && box.hasBind(e.deltaY < 0);
                target.classList.toggle('conflict', conflict);
